...
def print_large_text(message: str, status_code: str, ascii_response: str = ""):
    ...
    if ascii_response:
        payload_content = Align.center(
            # f"[white]Full Response: [cyan]{ascii_response}\n"
            # f"[white]ASCII Payload: [cyan]{ascii_response}[/]",
        ...
        while True:
            ...
            if result['status_changed']:
                ...
                print_large_text(
                    ...
                    result['status_code'],
                    result['ascii_payload']  # Pass the ASCII response here
                )
                flag = 0
